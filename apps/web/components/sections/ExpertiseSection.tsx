  ...
  return (
    <SectionContainer id="expertise">
      ...
      <div className="mt-12 flex flex-wrap gap-6">
        {pillars.map((pillar) => (
          <div key={pillar.title} className="flex flex-1 min-w-[18rem]">
            <article className="h-full w-full rounded-3xl border border-[color:var(--color-border-light)] bg-[color:var(--color-card-background)]/85 p-6 shadow-md">
