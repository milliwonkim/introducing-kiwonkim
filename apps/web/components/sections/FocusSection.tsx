  ...
  return (
    ...
    >
      ...
      <div className="mt-12 flex flex-wrap gap-6">
        {areas.map((area) => (
          <div key={area.title} className="flex flex-1 min-w-[18rem]">
            <article className="h-full w-full rounded-3xl border border-[color:var(--color-border-light)] bg-[color:var(--color-background)]/80 p-6 shadow-sm transition-transform duration-300 hover:-translate-y-1">
