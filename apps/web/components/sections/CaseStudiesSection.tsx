  ...
  return (
    <SectionContainer id="work" className="bg-[color:var(--color-card-background)]/40">
      ...
      <div className="mt-14 flex flex-wrap gap-8">
        {studies.map((study) => (
          <div key={study.title} className="flex flex-1 min-w-[20rem]">
            <article className="flex h-full flex-col rounded-3xl border border-[color:var(--color-border-light)] bg-[color:var(--color-background)]/85 p-7 shadow-lg shadow-[color:var(--color-card-shadow)]/60">
