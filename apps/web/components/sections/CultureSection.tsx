  ...
  return (
    <SectionContainer id="culture" className="bg-[color:var(--color-card-background)]/50">
      ...
      <div className="mt-10 flex flex-wrap gap-5">
        {signals.map((signal) => (
          <div key={signal.title} className="flex flex-1 min-w-[18rem]">
            <article className="h-full w-full rounded-3xl border border-[color:var(--color-border-light)] bg-[color:var(--color-background)]/85 p-6 shadow-sm">
